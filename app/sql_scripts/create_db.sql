/*
Authors: 
    Julia (especially if we have kept parts)
    Sofia Monsalve

Aim: 
    This script builds the bacterial_growth db scheme
...
CREATE TABLE CompartmentsPerEvent (
    ...
    FOREIGN KEY (communityUniqueId) REFERENCES Community(communityUniqueId)
);
...
CREATE TABLE IF NOT EXISTS Perturbation (
    ...
    OLDCommunityId VARCHAR(20),
    NEWCompartmentId VARCHAR(20),
    NEWCommunityId VARCHAR(20),
