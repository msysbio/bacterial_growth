...
create table if not exists Experiment (
    ...
    experimentDescription text default '',
...
create table if not exists CultivationConditions(
	cultivationId int,
    cultivationDescription text default '',
    experimentId int,
...
create table if not exists TechnicalReplicates (
	replicateId int,
    replicateDescription text default '',
    cultivationId int,
